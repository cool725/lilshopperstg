    ...
    <div class="relative py-12 lg:py-[4%] xl:py-14">
        <div class="w-4/5 max-w-7xl mx-auto py-7 lg:py-[2%] xl:py-7 flex flex-col lg:flex-row items-start justify-between">
            <ul class="flex-1 w-full lg:mr-[8%]">
                <li class="bg-white rounded-xl p-7 shadow-lg mb-[9%]">
                    <div class="flex max-w-[550px] break-words">
                        <div>
                            <a href="/holiday-shop-gifts">
                                <span class="w-20 shadow-lg rounded-full overflow-hidden block">
                        ...
                        <div class="pl-4">
                            <h4 class="text-[28px] font-bold leading-7 text-[#cd5c5c] pb-2">
            ...
            <div class="flex-1">
                <div class="p-9 pt-0 text-center">
                    <div class="mb-5">
                        <h1 class="text-4xl font-bold text-[#333] mb-2">Lil' Shopper's Shoppe Introduction Video</h1>
                        <p class="text-base">
                    ...
                    <div class="flex justify-center">
                        <a class="group flex items-center text-white text-xl leading-7 py-1 px-4 bg-[#E02B20] border-2 border-white rounded-3xl shadow transition-all duration-300 ease-in"
                            href="https://youtu.be/1wBeBPNUdeo" target="_blank">
                            Watch on YouTube
                            <span
                                class="opacity-0 -translate-x-full group-hover:opacity-100 group-hover:translate-x-0 text-[32px] transition-all duration-200 ml-2">
