<header class="shadow-2xl min-h-[224px]">
    <div class="py-7 flex flex-col lg:flex-row justify-center">
        <div class="lg:w-1/4">
            ...
            <img decoding="async" loading="lazy" width="350" height="100"
                src="/img/Better-World-Fundraising-Logo-350x100-1.png" alt="" title=""
                srcset="/img/Better-World-Fundraising-Logo-350x100-1.png 350w, /img/Better-World-Fundraising-Logo-350x100-1-300x86.png 300w"
                sizes="(max-width: 350px) 100vw, 350px" class="mx-auto">
        </div>
        ...
        <div class="lg:w-1/4 text-lg font-bold text-center text-[#666] break-words">
            <p>Better World Fundraising</p>
            <p>Customer Service</p>
            <p class="text-[#cd5c5c]">
                <a href="tel:888-871-5742">888-871-5742</a>
            </p>
            <p class="text-[#cd5c5c]">
                <a href="mailto:wecare@betterworldfundraising.com">wecare@betterworldfundraising.com</a>
            </p>
        </div>
    </div>
